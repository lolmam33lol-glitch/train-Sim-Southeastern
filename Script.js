...
const MenuState = {
  ...
  TRAIN_SELECT_MENU: 'trainSelectMenu',
...
function updateMenuVisibility() {
  ...
  if(currentMenuState === MenuState.MAIN_MENU) mainMenu.style.display = 'flex';
  else if(currentMenuState === MenuState.SETTINGS_MENU) settingsMenu.style.display = 'flex';
  else if(currentMenuState === MenuState.TRAIN_SELECT_MENU) trainSelectMenu.style.display = 'flex';
}

// Main Menu Logic
playBtn.onclick = () => { currentMenuState = MenuState.TRAIN_SELECT_MENU; updateMenuVisibility(); };
settingsBtn.onclick = () => { currentMenuState = MenuState.SETTINGS_MENU; updateMenuVisibility(); };
backFromSettings.onclick = () => { currentMenuState = MenuState.MAIN_MENU; updateMenuVisibility(); };
...
trainBtns.forEach(btn=>{
  btn.onclick = () => {
    ...
    currentMenuState = MenuState.SIMULATION;
...
menuIcon.onclick = ()=>{
  if(currentMenuState !== MenuState.SIMULATION) {
